...
$router->group(['prefix' => 'api'], function () use ($router) {
    ...
    $router->delete('postingan_delete', 'PostinganController@postingan_delete');
    ...
    $router->get('user_get_by_id/{id}', 'UserController@getPesananByIdUser');
    $router->put('user_update', 'UserController@getUserById');
});
